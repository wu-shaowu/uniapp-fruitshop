<template>
  <view>
    ...
    <view class="order-body bg-white">
      ...
      <view class="padding grid col-2">
        <view class="text-center" style="" @click="userThemselves">
          <image :src="SendShopMethod == 'ziti'?'../../static/car/yuyu-liang.png':'../../static/car/yuyu-hui.png' "
            mode="" style="width: 250upx;height: 100upx;"></image>
        </view>

        <view class="text-center" style="" @click="shopDistribution">
          <view class="">
            <image
              :src="SendShopMethod == 'peisong'?'../../static/car/biaoju-liang.png':'../../static/car/biaoju-hui.png' "
              mode="" style="width: 250upx;height: 100upx;"></image>
          </view>
      ...
      <view class="padding" v-if="SendShopMethod == 'peisong'">
        <view @click="getUserHomeLocation">
          <view class="padding-left-sm ">
            <text class="cuIcon-locationfill text-gray" style="font-size: 14px;"></text><text
              style="margin-left: 10upx;color: #666666;">点击去选择地址</text>
          </view>
        </view>
      </view>
    ...
    <view class="order-body bg-white" style="padding-bottom: 20upx;">
      <view class="padding-sm text-black" style="font-size: 16px;font-weight: 600;">日鲜地址</view>
      <view class="text-gray padding-left-sm">
        <text class="cuIcon-locationfill text-blue" style="font-size: 16px;"></text><text
          style="font-size: 14px;">广东省江门市五邑大学</text>
      </view>

      <map style="width: 97%; height: 200px;margin: 10upx;" :latitude="latitude" :longitude="longitude"
        :markers="covers"></map>
    </view>
